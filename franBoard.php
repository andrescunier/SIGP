                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <div class="d-sm-flex align-items-center mt-1 justify-content-between">
                                  <div class="d-sm-flex align-items-center mt-4 justify-content-between"><h2 class="me-2 fw-bold">$400000</h2><h4 class="me-2">USD</h4><h4 class="text-success">(+1.37%)</h4></div>
