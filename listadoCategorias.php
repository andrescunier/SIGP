...
<div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h1 class="card-title">LISTADO DE CATEGORIAS:
...
<?php foreach($listaProductos as $producto) { ?>
  <tr>
                         <td width="20%" class="buscar" ><?php echo $producto['ID'] ?></td>
                         <td width="20%" class="buscar" ><?php echo $producto['categoria'] ?></td></td>
                         <td width="20%" class="buscar" text-center></td>
                            ...
                            <button class="btn btn-danger"  type="submit" name="btnAccion" value="ModificarCategorias">Modificar Datos</button> 
                            </form>
                            </td>
                            ...
                            id="DNI" 
                            value="<?php echo ( $producto['ID']);?>">    
                            <button class="btn btn-danger"  type="submit" name="btnAccion" value="VerMovCategoria">Ver Movimientos</button> 
                            </form>
                            </td>
