...
<div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h1 class="card-title">LISTADO COMPRAS
              ...
              <div class="form-group row">
                  <form action="listadoCompras.php" method="get" class="form-sample" target="_blank">
  ...
  <td width="8%"><?php $date=date_create($producto['Fecha']) ; echo date_format($date,"Y/m/d") ?></td>
       ...
       <div class="card">
           <div class="card-body">
            <a href="excelCompras.php?desde=<?php echo $desde?>&hasta=<?php echo $hasta?>"><h1 class="card-title">ENVIAR INFORME A EXCEL
