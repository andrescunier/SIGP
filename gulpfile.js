...
gulp.task('injectLayoutStyles', function () {
    ...
    var verticalDarkStream = gulp.src('./**/vertical-default-dark/**/*.html')
        ...
        .pipe(gulp.dest('.'));
    var verticalBrownStream = gulp.src('./**/vertical-default-brown/**/*.html')
    .pipe(inject(gulp.src([
        './css/vertical-layout-brown/style.css', 
    ], {read: false}), {relative: true}))
    .pipe(gulp.dest('.'));
    return merge(verticalLightStream, horizontalLightStream, horizontalDarkStream, verticalDarkStream, verticalBrownStream);
});
