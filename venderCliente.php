...
?>
    ...
    <?php $total=0; ?>
        <?php foreach($_SESSION['VENTAS'] as $indice=>$prov) { ?>   
...
<?php } ?>
                          ...
                          <div class="container-fluid w-100">
                            ...
                            <a href="mostrarcarritoVentas.php" class="btn btn-success float-right mt-4 ms-2"><i class="ti-shopping-cart"></i>CARGAR VENTA</a>
