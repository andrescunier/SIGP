...
<a href="CobrarCliente.php" class="btn btn-success float-right mt-4 ms-2"><i class="ti-shopping-cart"></i>MENU ANTERIOR</a>
...
<table class="table table-striped ">
    <tbody>
        ...
        <tr>
            <td colspan="5">
                <form class="form-style-5" action="ingresos.php" method="post">
