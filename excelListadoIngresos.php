...
<td>0</td>
                            ...
                            <td style="text-align:center ;"><?php echo $SaldoComienzo;?></td>
                            <td style="text-align:center ;"><?php echo $SaldoComienzo;?></td>
       </tr>
...
<?php foreach($listaProductos as $producto) { ?>
  ...
  <td width="10%" text-center ><?php echo date($producto['Fecha']) ?></td>
                     ...
                     <td width="15%">$<?php echo $producto['CANTIDAD']*$producto['PRECIOUNITARIO']; ?></td>
                     <?php  $SaldoComienzo=$SaldoComienzo+$producto['CANTIDAD']*$producto['PRECIOUNITARIO']?>
                     <td width="15%"><?php echo $SaldoComienzo; ?></td>
