...
<?php } ?>
                          ...
                          <div class="container-fluid w-100">
                            ...
                            <a href="mostrarcarritoPagos.php" class="btn btn-success float-right mt-4 ms-2"><i class="ti-shopping-cart"></i>CARGAR PAGO</a>
                            <a href="listadoProveedorPago.php" class="btn btn-danger float-right mt-4"><i class="ti-back-left"></i>CANCELAR PAGO</a>
                          </div>
                      </div>
                  </div>
              </div>
