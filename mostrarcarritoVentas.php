...
?>
<!-- /* <?php print_r ($_SESSION['VENTAS']);?>
<?php print_r ($_SESSION['CARRITOVENTA']);?>*/-->
<?php $soc=$_SESSION['VENTAS'];?>
...
<a href="venderCliente.php" class="btn btn-success float-right mt-4 ms-2"><i class="ti-shopping-cart"></i>MENU ANTERIOR</a>
<a href="listadoClientesVentas.php" class="btn btn-danger float-right mt-4"><i class="ti-back-left"></i>CANCELAR VENTA</a>
</div>
...
<table class="table table-striped ">
    <tbody>
        ...
        <tr>
            <td colspan="5">
                <form class="form-style-5" action="pagarVentas.php" method="post">
...
<?php foreach($listaProductos as $indice=>$producto) { ?>
                ...
                $sentencia=$pdo->prepare("SELECT * FROM `comprobantes` where tipo='Venta' ");
            $sentencia->execute();
