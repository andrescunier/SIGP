    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        ...
        <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="">Buen día, recorda estar  <span class="text-black fw-bold">al día</span></h1>
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                ...
                <p class="mb-1 mt-3 font-weight-semibold">KICK FC</p>
              <!--  <p class="fw-light text-muted mb-0"><?php print_r($_SESSION['LOGIN']);?></p>-->
              </div>
              <a class="dropdown-item" href="http://www.dosvias.com.ar/GRU6/KICK6/menu.php"><i class="dropdown-item-icon mdi mdi mdi-autorenew text-primary me-2"></i> Ir a Grun</a>
              <a class="dropdown-item"href="http://www.dosvias.com.ar/E986/KICK6/menu.php"><i class="dropdown-item-icon mdi mdi mdi-autorenew text-primary me-2"></i> Ir a E98</a>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="e-commerce">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/samples/orders.html"> Planilla </a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
