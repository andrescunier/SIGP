...
<div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h1 class="card-title">LISTADO DE MOVIMIENTOS:
...
<?php } ?> </h1>
              ...
              <div class="form-group row">
                  <form action="listadoMediosDePago2.php" method="get" class="form-sample" target="_blank">
...
<?php foreach($listaProductos as $producto) { ?>
  ...
  <td width="10%" text-center ><?php echo date($producto['Fecha']) ?></td>
            ...
            <div style="align:right;"><a href="excelMovCaja.php?desde=<?php echo $desde?>&hasta=<?php echo $hasta?>&SaldoComienzo=<?php echo $SaldoComienzo?>"><button type="button" class="btn btn-secondary">Exportar a Excel</button></a></div> 
