...
<?php 
 ...
 if($_POST){
        ...
        $sentencia->execute(); 
            ...
            VALUES (now(), :Fecha,:Comprobante,:SOCIO,:Observaciones,'Pago',:MovCtaCte*-1,:Complejo,:IDVENTA,:MovCtaCte*-1);");    
            $sentencia->bindParam(":Fecha",$Correo);
...
window.location.replace('listadoProveedorPago.php'); 
}, 3000);
</script>
