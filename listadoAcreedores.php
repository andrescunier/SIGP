...
<div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h1 class="card-title">LISTADO DE PROVEEDORES PARA MODIFICAR</h1>
              <div class="row">
                <div class="col-12">
...
<?php foreach($listaProductos as $producto) { ?>
 ...
 <td>
                 ...
                 value="<?php echo ( $producto['SOCIO']);?>">  
                              <button class="btn btn-outline-primary" type="submit" name="btnAccion" value="ModificarProvee">Modificar Datos</button> 
                            </td>  
