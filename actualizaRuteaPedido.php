...
if($_POST){
        ...
        foreach ($_SESSION['RUTEO'] as $indice => $producto){
            $sentencia=$pdo->prepare("UPDATE tblventas SET `PayPalDatos`=:RUTEO , `horario`=now()  WHERE `ID`=:ID ");            
...
$mail->Body = "{$mensajeHtml} <br /><br />Pedido Entregado <br />"; // Texto del email en formato HTML
...
<script> 
<!--
window.location.replace('listadoEnRuta.php'); 
//-->
</script>
