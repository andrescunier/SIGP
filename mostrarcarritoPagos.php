...
<a href="PagarProvee.php" class="btn btn-success float-right mt-4 ms-2"><i class="ti-shopping-cart"></i>MENU ANTERIOR</a>
<a href="listadoProveedoresPago.php" class="btn btn-danger float-right mt-4"><i class="ti-back-left"></i>CANCELAR COBRO</a>
</div>
