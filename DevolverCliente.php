...
<?php foreach($listaProductos as $producto) { ?>
    <h3 class="text-right my-5">CARGAR DEVOLUCION :<?php echo $producto['NOMBRE'] ?>  </h3>
    <?php } ?> 
...
<?php } ?>
                          ...
                          <div class="container-fluid w-100">
                            ...
                            <a href="mostrarcarritoDevolver.php" class="btn btn-success float-right mt-4 ms-2"><i class="ti-shopping-cart"></i>CARGAR COBRO</a>
