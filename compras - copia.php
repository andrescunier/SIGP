...
<?php if(!empty($_SESSION['COMPRAS'])) { ?>
    ...
    <h3>Compras de  <?php echo $prov['DNI'] ?>  </h3>
         ...
         <?php foreach($listaProductos as $producto) { ?>
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <input type="hidden" name="DNI" id="DNI" value="<?php echo  $SOCIO;?>">
                <input type="hidden" name="id" id="id" value="<?php echo openssl_encrypt( $producto['ID'],COD,KEY);?>">
                <input type="hidden" name="nombre" id="nombre" value="<?php echo openssl_encrypt($producto['Nombre'],COD,KEY);?>">
               
                <input type="number" name="cantidad" id="cantidad" value="1">
                <input type="number" name="precio" id="precio" value="<?php echo $producto['Precio']?>">
                  <button class="btn btn-primary" name="btnAccion" value="AgregarItem" type="submit">Agregar al Carrito
