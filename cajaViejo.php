...
?>
 <div class="main-panel">
      ...
      <th >Saldo</th>
                      ...
                      <?php
            $sentencia=$pdo->prepare('SELECT MediosDePago.Medio AS MEDIO,clientes.Nombre AS GASTO ,tblctasctes.status AS TIPOPAGO ,tbldetallpagos.CANTIDAD * tbldetallpagos.PRECIOUNITARIO AS TOTAL , ctactes.N°Comprobante as COMPROBANTE from tblctasctes LEFT JOIN tbldetallpagos on tblctasctes.ID=tbldetallpagos.IDVENTA LEFT JOIN MediosDePago on tbldetallpagos.IDPRODUCTO=MediosDePago.ID LEFT JOIN clientes ON tblctasctes.SOCIO=clientes.SOCIO LEFT JOIN ctactes ON tblctasctes.id=ctactes.IDPAGO where (tblctasctes.status="Pago" and tbldetallpagos.DESCARGADO=0 and MEDIO='$medioPago')
